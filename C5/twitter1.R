...
twitter_token <- create_token (   app = "DUrtweet",   consumer_key = "0glwhLXXAahrusA3Dxvhou82M", consumer_secret = "bItULC8KINiNFIWcMBDekO6IztIoHeQ8yD6STqxbvIBxRCePZx")

rt1 <- search_tweets("business analytics", n = 100, token = twitter_token)
rt1
rtweet::write_as_csv(rt1, 'text/tweets1.csv')
...
create_token(
  ...
  consumer_secret = "bItULC8KINiNFIWcMBDekO6IztIoHeQ8yD6STqxbvIBxRCePZx",  access_token = "14366551-KKd2B8pb5as86RKNf6sgULoM2aoL1JxspMzstXH8h",
